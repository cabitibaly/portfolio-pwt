...
const NosValeurSection = () => {
    return (
        <>
            ...
            <div className="overflow-hidden px-[100px] py-16 relative z-30 top-0 left-0 w-screen min-h-screen flex flex-col items-center justify-start gap-12 max-896:px-4 max-896:py-8">                                
...
export default NosValeurSection
